...
import com.pujiy.mywarehouse.databinding.DialogDefaultBinding;
...
public class CustomDialog {
    ...
    public CustomDialog subTitle(CharSequence subTitle) {
        binding.toolbar.setSubtitle(subTitle);
        return instance;
    }

    public CustomDialog subTitle(@StringRes int subTitle) {
        binding.toolbar.setSubtitle(subTitle);
        return instance;
    }
